...
def upsert_to_database(file_path, connection, employee_username, start_time):
    ...
    ''', (
        hostname, ipaddrs, hostname, file_path, file_size, file_name, file_extension, creation_time, modification_time,
        access_time, start_time, employee_username, employee_username, start_time,
...
def insert_machine_info_for_search(connection, ipaddress, hostname, ops, os_name, os_version, system_info):
    if ops == "Windows":
        ...
        total_excel_files = count_files_with_extension(directory_path, ".xls") + count_files_with_extension(
            directory_path, ".xlsx")
        total_word_files = count_files_with_extension(directory_path, ".docx") + count_files_with_extension(
            directory_path, ".doc")
    ...
    try:
        ...
        cursor.execute('''
                INSERT INTO machine_info_for_search (hostname, ip_address, os_name, os_version, system_info, total_n_files, total_n_excel, total_n_pdf, total_n_word, total_n_zip)
            ...
            ''', (
            hostname, ipaddress, os_name, os_version, system_info_str, total_files, total_excel_files, total_pdf_files,
            total_word_files, total_zip_files))
        connection.commit()
