...
/* CREATE TABLE IF NOT EXISTS env_info (
  ...
  enable_file_ext_count_in_scan  varchar(10) DEFAULT NULL,
  d_file_details_file_extensions varchar(1500) DEFAULT NULL,
  n_days int DEFAULT NULL,
  is_sensitive_file_extensions varchar(1500) DEFAULT NULL,
  file_path_scan_sensitive_patterns varchar(250) DEFAULT NULL,
  enable_excel_file_data_scan varchar(100) DEFAULT NULL,
  enable_excel_file_data_scan_min_row int DEFAULT NULL,
