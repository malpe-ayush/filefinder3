...
CREATE TABLE IF NOT EXISTS f_machine_files_summary_count (
  ...
  total_n_ppt int DEFAULT NULL,  
  total_n_pptx int DEFAULT NULL,  
  total_n_txt int DEFAULT NULL,  
  total_n_rtf int DEFAULT NULL,
  total_n_csv int DEFAULT NULL,
  total_n_tsv int DEFAULT NULL,  
  total_n_pst int DEFAULT NULL,
  total_n_sql int DEFAULT NULL,
  total_n_db int DEFAULT NULL,
  total_n_dbf int DEFAULT NULL,  
  total_n_mdb int DEFAULT NULL,
  total_n_bak int DEFAULT NULL,
  total_n_zip int DEFAULT NULL,
  total_n_gz int DEFAULT NULL,  
  total_n_tar int DEFAULT NULL,
  total_n_rar int DEFAULT NULL,
  total_n_7z int DEFAULT NULL,
  total_n_jpg int DEFAULT NULL,  
  total_n_png int DEFAULT NULL,
  total_n_gif int DEFAULT NULL,
  total_n_mp3 int DEFAULT NULL,
