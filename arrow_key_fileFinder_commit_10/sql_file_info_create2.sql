...
CREATE DATABASE IF NOT EXISTS lisney_files_info2 /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
use lisney_files_info2;


/*.pdf, .xls, .xlsx, .doc, .docx,  .ppt,.pptx, .txt, .rtf, .csv, .tsv, .pst, 
.sql, .db, .dbf, .mdb,  .bak,  .zip, .gz, .tar, .rar, .7z, .jpg, 
.png, .gif, .mp3, .mp4, .xml, .html, .htm, .log,  .odt, .ods, 
.odp, .odg, .odf, .od, .exe, .dll, .avi, .bat, .reg, 
.css, .js, .lnk, .sys, .ini, .wav, .
bmp, .tif, .iso, .dat,  .psd, .ai, .eps*/
CREATE TABLE IF NOT EXISTS f_machine_files_summary_count (
  f_machine_files_summary_count_pk int NOT NULL AUTO_INCREMENT,
  hostname varchar(100) DEFAULT NULL,  ip_address varchar(50) DEFAULT NULL,
  os_name varchar(100) DEFAULT NULL,  os_version varchar(100) DEFAULT NULL,
  system_info varchar(1000) DEFAULT NULL,  number_of_drives int DEFAULT NULL,
  name_of_drives varchar(1000) DEFAULT NULL,  total_n_files int DEFAULT NULL,  total_n_pdf int DEFAULT NULL,
  total_n_xls int DEFAULT NULL,  total_n_xlsx int DEFAULT NULL,  total_n_doc int DEFAULT NULL,  total_n_docx int DEFAULT NULL,
  total_n_ppt int DEFAULT NULL,  total_n_pptx int DEFAULT NULL,  total_n_txt int DEFAULT NULL,  total_n_rtf int DEFAULT NULL,
  total_n_csv int DEFAULT NULL,total_n_tsv int DEFAULT NULL,  total_n_pst int DEFAULT NULL,total_n_sql int DEFAULT NULL,
  total_n_db int DEFAULT NULL,total_n_dbf int DEFAULT NULL,  total_n_mdb int DEFAULT NULL,total_n_bak int DEFAULT NULL,
  total_n_zip int DEFAULT NULL,total_n_gz int DEFAULT NULL,  total_n_tar int DEFAULT NULL,total_n_rar int DEFAULT NULL,
  total_n_7z int DEFAULT NULL,total_n_jpg int DEFAULT NULL,  total_n_png int DEFAULT NULL,total_n_gif int DEFAULT NULL,
  total_n_mp3 int DEFAULT NULL,total_n_mp4 int DEFAULT NULL,  
